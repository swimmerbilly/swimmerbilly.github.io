...
A personal assistant and life organizer for managing projects alongside emails, texts, calls, and voicemails — all in one place.
...
Or run backend and frontend separately (see below).
...
- [x] Link emails/texts/voicemails to projects from the UI
